...
- After a PR is merged, automatically delete the feature branch locally and remotely, switch back to `main`, and sync `main` with `origin/main` without stopping to ask permission.
